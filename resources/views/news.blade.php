...
<body>
    ...
    <div class="container-judul">
        <h1 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
            {{ $translator->translate('HOT NEWS') }}</h1>
    </div>

    <div class="container-hotnews" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">

        @php $hot = $news->firstWhere('id', 2); @endphp

        @if ($hot)
            <div class="top-box">
                <div class="stuff">
                    <a href="{{ route('news.detail', ['id' => $hot->id]) }}">
                        <img alt="{{ $hot->caption_image }}" src="{{ url("storage/{$hot->photo}") }}" />
                    </a>
                </div>
                <div class="judul-berita">
                    <h1>{{ $hot->title }}</h1>
                    <p>{!! Str::limit($hot->content, 100) !!}</p>
                </div>
            </div>
        @endif


        @php $hot = $news->firstWhere('id', 3); @endphp

        @if ($hot)
            <div class="left-box" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                <div class="stuff">
                    <a href="{{ route('news.detail', ['id' => $hot->id]) }}">
                        <img alt="{{ $hot->caption_image }}" src="{{ url("storage/{$hot->photo}") }}" />
                    </a>
        ...
        @php $hot = $news->firstWhere('id', 1); @endphp
