                        ...
                        <div class="card-body">
                            <form action="{{ route('programs.update', $programs->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-md-6">
                                        ...
                                        <input type="file" id="image" name="image"
                                            ...
                                            data-default-file="{{ asset('storage/' . $programs->image) }}"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="name" id="name" cols="30" rows="5" class="form-control" required>{{ old('name', $programs->name) }}</textarea>
                                    @error('name')
                                        <small class="text-danger d-block">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="5" class="form-control" required>{{ old('description', $programs->description) }}</textarea>
                                    @error('description')
                                        <small class="text-danger d-block">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="duration" id="duration" cols="30" rows="5" class="form-control" required>{{ old('duration', $programs->duration) }}</textarea>
                                    @error('duration')
                                        <small class="text-danger d-block">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3 col-md-3">
                                    ...
                                    <select class="form-control" name="status" required>
                                        <option value="0"
                                            {{ old('status', $programs->status) == '0' ? 'selected' : '' }}>Hide
                                        </option>
                                        <option value="1"
                                            {{ old('status', $programs->status) == '1' ? 'selected' : '' }}>Show
                                        </option>
                                    </select>
                                    @error('status')
                                        <small class="text-danger d-block">{{ $message }}</small>
                                ...
                                <div class="form-group mb-3 col-md-3">
                                    ...
                                    <select class="form-control" name="category" required>
                                        @foreach (['National', 'International', 'Tailor-Made', 'In-House-Program', 'Hourly-Based'] as $option)
                                            <option value="{{ $option }}"
                                                {{ old('category', $programs->category) == $option ? 'selected' : '' }}>
                                                {{ $option }}
                                            </option>
                                        @endforeach
                                    </select>
