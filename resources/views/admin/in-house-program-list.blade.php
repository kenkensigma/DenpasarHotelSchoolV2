...
<head>
    ...
    <title>AdminLTE 3 | In House Program</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">In House Program</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">In House Program</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <a href="{{ route('in-house-program-add') }}" class="blue-button">Add Program</a>

                    <!-- Alert for success message -->
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">In House Program</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    @foreach ($inHousePrograms as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('in-house-program-delete', $item->id) }}"
