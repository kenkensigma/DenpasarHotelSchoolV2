                            ...
                            <form action="{{ route('team.update', $teams->id) }}" method="POST"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="roles" class="form-control"
                                        value="{{ old('roles', $teams->roles ?? '') }}" required>
                                </div>
                                ...
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <input type="file" id="foto" name="foto" class="form-control dropify"
                                        data-max-file-size="2M" data-allowed-file-extensions="jpg png jpeg"
                                        data-default-file="{{ asset('storage/' . $teams->foto) }}" />
                                ...
                                <div class="form-group mb-3 col-md-3">
                                    ...
                                    <select class="form-control" name="status" value="{{ $teams->status }}"
                                        required>
