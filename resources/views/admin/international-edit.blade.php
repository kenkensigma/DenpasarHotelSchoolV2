                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Form Edit International</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{ route('international-update', $MainInternationalProgram->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-md-6">
                                        ...
                                        <input type="file" id="image" name="image"
                                            ...
                                            data-default-file="{{ asset('storage/' . $MainInternationalProgram->image) }}"
...
{{ old('description', strip_tags($MainInternationalProgram->description)) }}
</textarea>
                                </div>
