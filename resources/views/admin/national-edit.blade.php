                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Form Edit National</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{ route('national-update', $MainNationalProgram->id) }}" method="POST"
...
{{ old('description', strip_tags($MainNationalProgram->description)) }}
</textarea>
                                </div>
