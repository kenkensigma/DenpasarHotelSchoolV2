...
<head>
    ...
    <title>AdminLTE 3 | Gallery Edit</title>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Form Edit Photo</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{ route('sub-national-update', $SubNationalProgram->id) }}" method="POST"
                                enctype="multipart/form-data" class="custom-validation">
                                @csrf
                                @method('PUT')

                                <div class="form-group">
                                    <label for="main_program_id">Main Program</label>
                                    <select name="main_program_id" id="main_program_id" class="form-control"
                                        required>
                                        <option value="">-- Pilih Main Program --</option>
                                        @foreach ($MainNationalPrograms as $program)
                                            <option value="{{ $program->id }}"
                                                {{ old('main_program_id', $SubNationalProgram->main_program_id) == $program->id ? 'selected' : '' }}>
                                                {{ $program->tag }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" name="title" class="form-control"
                                        value="{{ old('title', $SubNationalProgram->title) }}" required>
                                </div>

                                <div class="form-group mt-3">
                                    <label for="description">Deskripsi</label>
                                    <textarea name="description" class="form-control" rows="5" required>{{ old('description', strip_tags($SubNationalProgram->description)) }}</textarea>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group mb-3 col-md-6">
                                        ...
                                        <input type="file" id="image" name="image"
                                            ...
                                            data-default-file="{{ asset('storage/' . $SubNationalProgram->image) }}"
