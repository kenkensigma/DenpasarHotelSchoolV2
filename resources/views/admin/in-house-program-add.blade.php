...
<head>
    ...
    <title>AdminLTE 3 | In House Program Add</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Add In House Program</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Add In House Program</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <div class="container mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3>Add In House Program</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('in-house-program-store') }}" method="POST"
