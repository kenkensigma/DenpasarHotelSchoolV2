...
<head>
    ...
    <title>AdminLTE 3 | Tailor Program Edit</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Tailor Program</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Edit Tailor Program</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <div class="container mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3>Add Tailor Program</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('tailor-program-update', $tailorPrograms->id) }}" method="POST"
                            ...
                            <div class="form-group mb-3">
                                    <label for="career_pathways_description" class="form-label">Career Pathways Description</label>
                                    <textarea name="career_pathways_description" id="career_pathways_description" cols="30" rows="5" class="form-control" required>{{ old('career_pathways_description') ? strip_tags(old('career_pathways_description')) : '' }}</textarea>
                                </div>
