...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/after-click.css') }}">
...
<body>
    ...
    <header class="header">
        <nav class="navbar">
            ...
            <div class="logo">
                <a href="home"><img src="{{ asset('img/logo_192509100957_ 1.png') }}" alt="Logo" width="80px"></a>
            </div>
    ...
    <section class="content-after">
        <div class="container">
            @forelse($SubNationalPrograms as $sub)
                <div class="card" data-aos="{{ $loop->odd ? 'fade-left' : 'fade-right' }}"
    ...
    <section class="order">
        <div class="card-order" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
            ...
            <div class="description">
                <p>{{ $translator->translate('Don’t mi’s out on these opportunities, join our program now!') }}</p>
                </di>
