        ...
        <div class="container">
            <div class="card">
                <div class="card-content">
                    <h3>{{ $translator->translate('Mentorship from Global Hospitality Leaders') }}</h3>
                    <p>{{ $translator->translate('Students receive mentorship from experienced managers and trainers within the partner hotel chains.') }}
                    </p>
                </div>
            ...
            <div class="card">
                <div class="card-content">
                    <h3>{{ $translator->translate('Rotational Internship Program') }}</h3>
                    <p>{{ $translator->translate('Students rotate through departments, including front office, housekeeping, food and beverage, and guest relations, building a well-rounded skill set.') }}
                    </p>
                </div>
            ...
            <div class="card">
                <div class="card-content">
                    <h3>{{ $translator->translate('Global Certification and Career Pathway') }}</h3>
                    <p>{{ $translator->translate('Upon completion, students receive a certificate from both Denpasar Hotel School and the partnering hotel, which can boost their global employability.') }}
                    </p>
                </div>
