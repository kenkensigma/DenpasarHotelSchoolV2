...
<body>
    ...
    <section class="content-after">
        <div class="container">
            <div class="card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="300">
                <div class="card-content">
                    <h3>{{ $translator->translate('Certificate of Hospitality Management') }}</h3>
                    <p>{{ $translator->translate('The Certificate of Hospitality Management provides training in hotel management, customer service, event planning, and leadership. It prepares individuals for managerial roles in the hospitality industry, focusing on business strategies, staff management, and quality service.') }}
                    </p>
                </div>
                <img src="../img/prog1-1.png" alt="Food Service Image">
            </div>
            <div class="card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('Certificate of Advanced Culinary Arts') }}</h3>
                    <p>{{ $translator->translate('The Certificate of Advanced Culinary Arts at Denpasar Hotel School refines culinary skills, focusing on advanced techniques, creative plating, menu development, and international cuisine. Led by experienced chefs, the program prepares participants for elevated roles in high-end kitchens and gastronomy.') }}
                    </p>
                </div>
                <img src="../img/prog1-2.png" alt="Hospitality Image">
            </div>
            <div class="card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('Certificate of Tourism and Event Management') }}</h3>
                    <p>{{ $translator->translate('Provides knowledge of tourism principles, event planning, and logistics. This program prepares students for roles in event coordination, tour operations, and hospitality event management.') }}
                    </p>
                </div>
                <img src="../img/prog1-3.png" alt="Food Service Image">
            </div>
            <div class="card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('Certificate of Advanced Food and Beverage Service') }}</h3>
                    <p>{{ $translator->translate('The Certificate of Food and Beverage Service at Denpasar Hotel School trains participants in service skills, restaurant operations, and customer interaction, preparing them for roles in restaurants, hotels, and catering services with a focus on professionalism and practical experience.') }}
                    </p>
                </div>
                <img src="../img/prog1-4.png" alt="Hospitality Image">
            </div>
        </div>
    </section>
