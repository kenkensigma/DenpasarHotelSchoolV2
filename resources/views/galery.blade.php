...
<head>
    ...
    <title>Gallery - Denpasar Hotel School</title>
    <!-- Link Swiper's CSS -->
...
<body>
    ...
    <section class="collection">
        <div class="container">
            <div class="container-title">
                <h2 data-aos="fade-up" data-aos-duration="1200">{{ $translator->translate('Our Photo') }}</h2>
            </div>
            <div class="gallery">
  ...
  <span class="nav-btn next" id="nextBtn">&#10095;</span>
        ...
        <div class="button-container" data-aos="zoom-in" data-aos-duration="800">
            <a href="#" class="btn-link">
                <button class="btn">{{ $translator->translate('See more') }}</button>
            </a>
        </div>
        </div>
    </section>
