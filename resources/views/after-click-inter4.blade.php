        ...
        <div class="container">
            <div class="card">
                <div class="card-content">
                    <h3>{{ $translator->translate('Bilateral Training') }}</h3>
                    <p>{{ $translator->translate('Training is conducted in both Indonesia and the European country, covering traditional European culinary techniques alongside Southeast Asian cuisine.') }}
                    </p>
                </div>
            ...
            <div class="card">
                <div class="card-content">
                    <h3>{{ $translator->translate('Culinary Internship') }}</h3>
                    <p>{{ $translator->translate('After completing studies, students intern in renowned European kitchens, experiencing the fast-paced environment and high standards of the European culinary scene.') }}
                    </p>
                </div>
            ...
            <div class="card">
                <div class="card-content">
                    <h3>{{ $translator->translate('Cross-Cultural Skill Development') }}</h3>
                    <p>{{ $translator->translate('Students learn to work in diverse, multicultural teams, a key skill in the international culinary industry.') }}
                    </p>
                </div>
