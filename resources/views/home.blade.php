...
<body>
    ...
    <!-- ------ JUMBOTRON SECTION ------ -->
    <div class="jumbotron">
        <video src="https://youtu.be/56ki5NE7Nwg?si=jOGwVuqRgLv6cc4B" autoplay loop muted
    ...
    <section id="about" class="hidden">
        <div class="homefotoatas" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
