            ...
            <div class="program-container">
                ...
                <div class="program-card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                    <a href="after-click-inter5">
                        <img src="img/program.png" alt="program 3">
                        <div class="program-title-text">
                ...
                <div class="program-card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                    <a href="after-click-inter4">
                        <img src="img/program.png" alt="program 4">
                        <div class="program-title-text">
            ...
            @foreach ($MainNationalPrograms as $index => $program)
                <div class="program hidden-right">
                    <div class="program-text">
                        ...
                        <div class="button-middle" data-aos="fade-right" data-aos-duration="1200"
                            data-aos-delay="200">
                            <a href="after-click-inter"
                                class="btn-middle">{{ $translator->translate('See more') }}</a>
                        </div>
                    </div>
