        ...
        <div class="container">
            <div class="card">
                <div class="card-content">
                    <h3>{{ $translator->translate('Exchange Study Modules') }}</h3>
                    <p>{{ $translator->translate('Students complete courses in an Australian school, learning best practices in sustainability, guest relations, and service excellence.') }}
                    </p>
                </div>
            ...
            <div class="card">
                <div class="card-content">
                    <h3>{{ $translator->translate('Hands-On Learning in Australian Hotels') }}</h3>
                    <p>{{ $translator->translate('The program includes supervised hands-on training sessions in local hotels and resorts.') }}
                    </p>
                </div>
            ...
            <div class="card">
                <div class="card-content">
                    <h3>{{ $translator->translate('Immersion in Australian Hospitality Culture') }}</h3>
                    <p>{{ $translator->translate('Cultural immersion activities help students understand and adapt to Australian hospitality standards.') }}
                    </p>
                </div>
