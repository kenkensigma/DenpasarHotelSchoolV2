...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <ul class="navbar-nav">
        ...
        {{-- News & Event --}}
        <li class="nav-item">
            <a class="nav-link text-dark" href="{{ url('projects') }}">
        ...
        <li class="nav-item">
            <a class="nav-link text-dark" href="{{ route('admin.tailor-program-list') }}">
                ...
                <span class="nav-link-text ms-1">Tailor Program</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link text-dark" href="{{ route('admin.in-house-program-list') }}">
                ...
                <span class="nav-link-text ms-1">In-House Program</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link text-dark" href="{{ route('admin.hourly-based-program-list') }}">
                ...
                <span class="nav-link-text ms-1">Hourly Based Program</span>
            </a>
        </li>
