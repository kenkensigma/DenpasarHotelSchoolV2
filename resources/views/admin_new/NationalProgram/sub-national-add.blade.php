            ...
            <div class="col-lg-7">
                ...
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-4">
                        ...
                        <h2 class="fw-bold mb-4">Tambah Sub National Program</h2>

                        <form action="{{ route('sub-national-store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <select name="main_program_id" id="main_program_id" class="form-control soft-input" required>
                                        <option value="">-- Pilih Main Program --</option>

                                        @foreach ($MainNationalPrograms as $program)
                                            <option value="{{ $program->id }}">{{ $program->tag }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="description" class="form-control soft-textarea" required>{{ old('description') }}</textarea>
                            </div>
