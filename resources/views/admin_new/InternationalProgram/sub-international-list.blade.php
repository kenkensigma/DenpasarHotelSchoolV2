...
@section('content')
    <div class="container-fluid py-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h3 class="fw-bold mb-1">Sub-International Program Management</h3>
                <p class="text-muted mb-0">Manage all sub-international programs on your website.</p>
            </div>

            <a href="{{ route('sub-international-add') }}" class="btn btn-primary shadow-sm px-4 py-2">
                <i class="bi bi-plus-circle"></i> Add Sub-International Program
            </a>
        </div>
                    ...
                    <tbody>
                        @foreach ($SubInternationalPrograms as $key => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('sub-international-edit', $item->id) }}"
                                        class="btn btn-outline-primary btn-sm rounded-pill px-3">
                                        Edit
                                    </a>

                                    <form action="{{ route('sub-international-delete', $item->id) }}" method="POST"
