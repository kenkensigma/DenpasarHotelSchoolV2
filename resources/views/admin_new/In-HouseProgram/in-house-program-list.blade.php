...
@section('content')
    <div class="container-fluid py-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h3 class="fw-bold mb-1">In House Program Management</h3>
                <p class="text-muted mb-0">Manage all in house programs on your website.</p>
            </div>

            <a href="{{ route('in-house-program-add') }}" class="btn btn-primary shadow-sm px-4 py-2">
                <i class="bi bi-plus-circle"></i> Add In House Program
            </a>
        </div>
        ...
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-body p-0">
                ...
                <table class="table table-hover mb-0 align-middle">
                    ...
                    <tbody>
                        @foreach ($inHousePrograms as $key => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('in-house-program-edit', $item->id) }}"
                                        class="btn btn-outline-primary btn-sm rounded-pill px-3">
                                        Edit
                                    </a>

                                    <form action="{{ route('in-house-program-delete', $item->id) }}" method="POST"
