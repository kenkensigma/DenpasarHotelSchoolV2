            ...
            <div class="col-lg-7">
                ...
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('in-house-program-store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <textarea name="sub_reason_description" class="form-control soft-textarea" required>{{ old('sub_reason_description') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="program_description" class="form-control soft-textarea" required>{{ old('program_description') }}</textarea>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <textarea name="highlights_description" class="form-control soft-textarea" required>{{ old('highlights_description') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <textarea name="program_delivery_description" class="form-control soft-textarea" required>{{ old('program_delivery_description') }}</textarea>
                                </div>
                            </div>

                            <div class="form-group mb-3">
                                <label class="soft-label">Target Audience Description</label>
                                <textarea name="target_audience_description" class="form-control soft-textarea" required>{{ old('target_audience_description') }}</textarea>
                            </div>
