...
<body>
    ...
    <section class="about">
        ...
        <div class="text-national" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
            <p>{{ $translator->translate('These programs range from skill-specific short courses to full professional training for those seeking long-term careers in hospitality. Let us know if you’d like more details on any program!') }}
            </p>
        </div>
    </section>
