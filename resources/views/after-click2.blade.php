...
<head>
    ...
    <link rel="stylesheet" href="../css/after-click.css" />
...
<body>
        ...
        <nav class="navbar">
            ...
            <ul class="nav-links right">
                ...
                <select class="changeLang">
                    ...
                    <option value="zh-CN" {{ session()->get('locale') == 'zh-CN' ? 'selected' : '' }}>Mandarin Chinese
                    </option>
                    ...
                    <option value="fa" {{ session()->get('locale') == 'fa' ? 'selected' : '' }}>Persian (Farsi)
                    </option>
                    ...
                    <option value="ku" {{ session()->get('locale') == 'ku' ? 'selected' : '' }}>Kurdish (Kurmanji)
                    </option>
                    <option value="ckb" {{ session()->get('locale') == 'ckb' ? 'selected' : '' }}>Kurdish (Sorani)
                    </option>
                    ...
                    <option value="ny" {{ session()->get('locale') == 'ny' ? 'selected' : '' }}>Chichewa (Nyanja)
                    </option>
                    ...
                    <option value="bts" {{ session()->get('locale') == 'bts' ? 'selected' : '' }}>Batak Simalungun
                    </option>
                    ...
                    <option value="mni-Mtei" {{ session()->get('locale') == 'mni-Mtei' ? 'selected' : '' }}>Meiteilon
                        (Manipuri)</option>
                    ...
                    <option value="nso" {{ session()->get('locale') == 'nso' ? 'selected' : '' }}>Northern Sotho
                    </option>
    ...
    <section class="content-after">
        <div class="container">
            <div class="card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('Certificate in Hotel Operations') }}</h3>
                    <p>{{ $translator->translate('The Certificate of Hospitality Management at Denpasar Hotel School trains participants in hotel management, customer service, event planning, and leadership. It prepares individuals for managerial roles in hospitality, focusing on business strategies, staff management, and quality service through practical experience and industry-focused coursework.') }}
                    </p>
                </div>
                <img src="../img/prog6-1.png" alt="Hospitality Image">
            </div>
            <div class="card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('Certificate of Culinary Basics and Kitchen Operations') }}</h3>
                    <p>{{ $translator->translate('The Certificate of Culinary Basics and Kitchen Operations at Denpasar Hotel School offers foundational training in cooking, kitchen organization, and food safety, preparing beginners with essential skills for working in professional kitchens and advancing in their culinary careers.') }}
                    </p>
                </div>
                <img src="../img/prog6-2.png" alt="Food Service Image">
            </div>
            <div class="card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('Certificate of Barista and Beverage Operations') }}</h3>
                    <p>{{ $translator->translate('The Certificate of Barista and Beverage Operations at Denpasar Hotel School trains participants in coffee brewing, beverage preparation, and café management, covering skills in customer service, inventory, and operations for careers as baristas or in beverage management.') }}
                    </p>
                </div>
                <img src="../img/prog6-3.png" alt="Hospitality Image">
            </div>
            <div class="card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('Certificate of Food and Beverage Service') }}</h3>
                    <p>{{ $translator->translate('The Certificate of Food and Beverage Service at Denpasar Hotel School provides practical training in table setting, customer interaction, and menu knowledge, preparing participants for careers in hospitality with a focus on professionalism, service standards, and operational efficiency.') }}
                    </p>
                </div>
                <img src="../img/prog6-4.png" alt="Food Service Image">
            </div>
            <div class="card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('Certificate of Housekeeping Operations') }}</h3>
                    <p>{{ $translator->translate('The Certificate of Housekeeping Operations at Denpasar Hotel School trains participants in cleaning techniques, room preparation, inventory control, and guest service, preparing them for entry-level housekeeping roles in hotels, resorts, and hospitality businesses') }}
                    </p>
                </div>
                <img src="../img/prog6-5.png" alt="Hospitality Image">
            </div>
        </div>
    </section>

    <section class="order">
        <div class="card-order" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
