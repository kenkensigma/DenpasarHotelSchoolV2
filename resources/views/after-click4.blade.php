...
<body>
    ...
    <div class="jumbotron">
        ...
        <div class="overlay">
            <p>{{ $translator->translate('Welcome to the Denpasar Hotel School') }}</p>
            <h1>{{ $translator->translate('PROGRAM') }}</h1>
        </div>
    </div>
        ...
        <div class="container">
            <div class="card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('Professional Culinary Arts and Kitchen Management') }}</h3>
                    <p>{{ $translator->translate('This program trains aspiring chefs and kitchen managers in advanced cooking, menu planning, kitchen operations, cost control, and staff coordination, preparing them for leadership roles in professional kitchens and restaurant management.') }}
                    </p>
                </div>
                <img src="../img/prog2-1.png" alt="Food Service Image">
            </div>
            <div class="card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('Food and Beverage Management') }}</h3>
                    <p>{{ $translator->translate('The Professional Food and Beverage Management Program at Denpasar Hotel School trains participants in managing food and beverage operations, focusing on service excellence, inventory control, menu design, and team leadership, preparing them for managerial roles in the hospitality industry.') }}
                    </p>
                </div>
                <img src="../img/prog2-2.png" alt="Hospitality Image">
            </div>
            <div class="card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('Hospitality and Tourism Management') }}</h3>
                    <p>{{ $translator->translate('The Hospitality and Tourism Management Program at Denpasar Hotel School provides training in hotel operations, travel planning, customer service, cultural awareness. It prepares participants for roles in hotels, resorts, tourism agencies, focusing on business management, marketing, guest relations, sustainable tourism practices.') }}
                    </p>
                </div>
                <img src="../img/prog2-3.png" alt="Food Service Image">
            </div>
            <div class="card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    <h3>{{ $translator->translate('International Hotel and Resort Management') }}</h3>
                    <p>{{ $translator->translate('The International Hotel and Resort Management program at Denpasar Hotel School prepares participants for leadership roles in global hospitality, covering guest services, operations, marketing, finance, and cross-cultural communication to manage high-end establishments and meet international standards.') }}
                    </p>
                </div>
                <img src="../img/prog2-4.png" alt="Hospitality Image">
            </div>
        </div>
    </section>
