...
@endphp
    ...
    <title>Contact - Denpasar Hotel School</title>
...
<body>
    ...
    <div class="overlay">
            ...
            <h1 data-aos="fade-in" data-aos-duration="1200" data-aos-delay="600">
                {{ $translator->translate('CONTACT') }}</h1>
        </div>
    </div> 
      ...
      <section class="about">
          ...
          <div class="container-title">
            ...
            <!-- Contact info versi mobile -->
            <section class="contact-info contact-info-mobile">
                ...
                <div class="info-text">
                    <h3>Address</h3>
                    <p>Jln. Ganetri IV No. 4 DPS 80237 Bali</p>
                </div>
                </div>
            </section>
          ...
          <div class="container">
            <div class="contact-box">
                ...
                <div class="form-container">
                  <h2>{{ $translator->translate('Get in Touch') }}</h2>
                  <p>{{ $translator->translate('We are here for you! How can we help?') }}</p>
                  ...
                  <form action="{{ route('contact.send') }}" method="POST">
                      ...
                      <div class="form-group">
                          <label for="message">{{ $translator->translate('Message') }}</label>
                          <textarea id="message" name="message" placeholder="Enter your message" required></textarea>
                      </div>
              
                      <button type="submit">{{ $translator->translate('Send') }}</button>
                  </form>
              </div>              
            </div>
        </div>
    ...
    <!-- Contact info versi dekstop -->
    <section>
        <div class="contact-container">
            <div class="contact-card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                <div class="text-card">                  
                  <h3><i class='bx bxs-phone'></i> 0877-6969-6969</h3>
                </div>
                <p>{{ $translator->translate('Get in touch with us at this number for assistance.') }}</p>
              </div>

            <div class="contact-card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                <div class="text-card">
                    <h3><i class='bx bxs-envelope'></i>{{ $translator->translate(' sahabat@dhs.or.id') }}</h3>
                </div>  
                <p>{{ $translator->translate('Have questions? Email us and we’ll get back to you soon.') }}</p>
              </div>
            
            <div class="contact-card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                <div class="text-card">
                  <h3>
                    <i class='bx bxs-location-plus'></i>{{ $translator->translate(' 0Jln. Ganetri IV No. 4 DPS 80237 Bali') }}</h3>
                </div>
                <p>{{ $translator->translate('Looking for us? Here’s our address!') }}</p>
              </div>
        </div>
      </section>
