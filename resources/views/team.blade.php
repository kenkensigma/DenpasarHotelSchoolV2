...
<head>
  ...
  @endphp
    ...
    <title>Our Team - Denpasar Hotel School</title>
...
<body>
    ...
    <div class="jumbotron">
      ...
      <div class="overlay">
          ...
          <h1 data-aos="fade-in" data-aos-duration="1200" data-aos-delay="600">{{ $translator->translate('TEAMS') }}</h1>
          <div class="kotak"></div>
      </div>
  </div>
...
<section class="team-join">
    ...
    <div class="join-desc">
    <p>We are a team of hospitality professionals from various generations. With the creativity and innovation of young, experienced, and skilled members, we strive to develop top-quality talent and provide solutions for the hospitality industry.
        Ready to be part of something great? Click Join the Team and start your journey with us today!
    </p>
    <!-- Tombol untuk membuka modal -->
    <a href="{{ route('team-add') }}" class="join-button">
        Join the Team
    </a>    
...
<div class="container">
    <div class="image-section">
        <img alt="A person in a suit sitting at a desk with a laptop, bookshelves in the background" height="400" src="../img/Dwija Sustana.png  " width="400"/>
        <div class="badge">
            Directur
        </div>
    </div>
    <div class="text-section">
        ...
        <p>
            leading the institution in shaping skilled professionals for the global hospitality industry.
        </p>
    </div>
</div>
    <div class="container-judul-2">
        <h1>OUR TEAM</h1>
    </div>
